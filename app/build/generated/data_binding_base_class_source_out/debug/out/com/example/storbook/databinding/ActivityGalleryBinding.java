...
public final class ActivityGalleryBinding implements ViewBinding {
  ...
  private ActivityGalleryBinding(@NonNull RelativeLayout rootView, @NonNull ImageView photo,
  ...
  public static ActivityGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGalleryBinding((RelativeLayout) rootView, photo, toolbar);
    }
