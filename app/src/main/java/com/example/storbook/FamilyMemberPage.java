...
public class FamilyMemberPage extends AppCompatActivity {
    ...
    private ActivityFamilyMemberPageBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_family_member_page);
